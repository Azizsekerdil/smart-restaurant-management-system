...
- Publishing a security vulnerability publicly before it has been fixed, when
  a private reporting channel was available
- Posting real customer, guest or staff personal data in an issue, a pull
...
with this Code of Conduct, and will communicate the reasons when appropriate.
...
the maintainer, using the contact details on the repository owner's GitHub
...
1. **Correction** — a private, written warning explaining the violation and
